                ...
                <div class="login-form">
                    <form action="{{ route('jobseeker.register') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="name" placeholder="First name" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname') }}" required autocomplete="firstname" autofocus>
                            @error('firstname')
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="name" placeholder="Last name" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ old('lastname') }}" required autocomplete="lastname" autofocus>
                            @error('lastname')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('jobseeker.registration') }}">
                        @csrf
